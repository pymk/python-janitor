...
class TestSplitIntoWords:
    ...
    def test_underscore_separated(self):
        assert split_into_words("hello_world") == ["hello", "world"]
    ...
    def test_acronym_in_pascal_case(self):
        assert split_into_words("HTTPSRequest") == ["HTTPS", "Request"]

    def test_multiple_delimiters(self):
        assert split_into_words("hello - world") == ["hello", "world"]

    def test_mixed_separators(self):
        assert split_into_words("Hello-world_foo") == ["Hello", "world", "foo"]

    def test_mixed_camel_and_delimiters(self):
        assert split_into_words("hello_World-foo") == ["hello", "World", "foo"]
    ...
    def test_leading_trailing_delimiters(self):
        assert split_into_words("_hello_world_") == ["hello", "world"]

    def test_unicode_camel_case(self):
        assert split_into_words("héLlo") == ["hé", "Llo"]
